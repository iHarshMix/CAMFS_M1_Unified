...
def run_experiment(args):
    ...
    experiment_id = f"primary__part{args.partition_seed}__seed{args.train_seed}"
    ...
    while controller.state == FederatedPhaseState.PHASE2:
        ...
        for track_id, t_info in policy.policy["tracks"].items():
            ...
            # Validation metrics
            dummy_val_dice = {"ET": 0.85, "TC": 0.88, "WT": 0.92, "macro": 0.8833}
            dummy_val_hd95 = {"ET": 3.5, "TC": 2.8, "WT": 2.1, "macro": 2.80}

            val_dices[track_id] = dummy_val_dice["macro"]
            ...
            for hid in authorized_clients:
                p2_logger.log_round(
                    ...
                    total_loss=0.17,
                    val_dice_dict=dummy_val_dice,
                    val_hd95_dict=dummy_val_hd95,
                )
            ...
            CheckpointManager.save_checkpoint(
                ...
                prototypes={"fused": fused_protos[track_id]},
                current_round=p2_round,
                val_macro_dice=dummy_val_dice["macro"],
            )
